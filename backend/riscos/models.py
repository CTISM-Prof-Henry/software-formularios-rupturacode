...
class Risco(models.Model):
    ...
    probabilidade_residual = models.CharField(max_length=50, blank=True)
    impacto_residual = models.CharField(max_length=50, blank=True)
    nivel_residual = models.CharField(max_length=50, blank=True)
