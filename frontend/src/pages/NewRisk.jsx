...
function NewRisk() {
  ...
  const {
    ...
    register,
    reset,
  } = useForm({ defaultValues: riskFormDefaults, mode: 'onBlur' })
  ...
  async function submitRisk(data) {
    ...
    try {
      ...
      reset()
      setSubmitFeedback({
        text: 'Risco cadastrado com sucesso.',
        type: 'success',
      })
    } catch (error) {
      setSubmitFeedback({
  ...
  return (
    ...
    >
      ...
      <form className="risk-form" id="new-risk-form" onSubmit={handleSubmit(submitRisk)}>
          ...
          <div className="form-grid two-columns">
            <FormField error={errors.department?.message} label="Setor/Departamento">
              <input
                ...
                placeholder="Ex: Reitoria, TI, Recursos Humanos"
                type="text"
                {...register('department', {
                  required: 'Informe o setor ou departamento.',
                })}
              />
            </FormField>
            ...
            <FormField error={errors.riskType?.message} label="Tipo de risco">
              <select
                ...
                {...register('riskType', {
                  required: 'Selecione o tipo de risco.',
                })}
              >
          ...
          <FormField error={errors.identifiedRisk?.message} label="Risco identificado">
            <textarea
              ...
              {...register('identifiedRisk', {
                minLength: {
                  message: 'Descreva o risco com mais detalhes.',
                  value: 12,
                },
          ...
          <div className="form-grid treatment-grid">
            ...
            <FormField error={errors.actionPlan?.message} label="Plano de ação">
              <input
                ...
                type="text"
                {...register('actionPlan', {
                  required: 'Informe o plano de ação.',
                })}
              />
            </FormField>
